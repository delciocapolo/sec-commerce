...
function TitleComponent(array $props = []): string
{
   ...
   return <<<HTML
      <div class="flex justify-between {$props['style']}">
         <div class="">
         ...
         <div class="">
            <a href="{$props['url_section']}" target="_self" rel="noopener noreferrer" class="flex items-center gap-1 hover:gap-3 duration-300 leading-11 px-5 rounded-sm text-(--primary-900)">
